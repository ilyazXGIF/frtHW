...
public class Main {
    ...
    public static int[] heroesHealth = {260, 250, 270, 250, 250, 250, 240, 400};
    public static int[] heroesDamage = {20, 15, 10, 0, 20, 7, 2, 5};

    public static String[] heroesAttackType = {"Physical", "Magical", "Kinetic", "Medik", "berserk", "Thor", "Lucky", "Golem"};

    public static int roundNumber;
    public static int hill = 50;
    ...
    public static void chooseBossDefence() {
        ...
        int randomIndex = random.nextInt(heroesAttackType.length); //рамбом
